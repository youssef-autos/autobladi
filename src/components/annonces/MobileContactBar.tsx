      ...
      <div className="flex items-center gap-2 px-3 pt-2.5 pb-[calc(0.625rem+env(safe-area-inset-bottom))]">
        {contactPhone &&
          (!revealed ? (
            <button
              type="button"
              onClick={handleCall}
              className="flex-1 inline-flex items-center justify-center gap-2 h-12 rounded-xl border-2 border-moroccan-red-500 bg-background text-moroccan-red-500 text-sm font-bold active:bg-moroccan-red-50"
            >
            ...
            <a
              ...
              className="flex-1 inline-flex items-center justify-center gap-2 h-12 rounded-xl border-2 border-moroccan-red-500 bg-background text-moroccan-red-500 text-sm font-bold active:bg-moroccan-red-50 tabular-nums"
            >
              <Phone className="size-4" aria-hidden="true" />
        ...
        {wa && (
          <a
            ...
            className="flex-1 inline-flex items-center justify-center gap-2 h-12 rounded-xl bg-moroccan-mint-500 text-white text-sm font-bold active:brightness-95"
          >
