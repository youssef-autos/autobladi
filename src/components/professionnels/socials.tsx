...
export function getDealerSocials(dealer: ProfessionnelDetail): SocialLink[] {
  ...
  if (dealer.instagram) out.push({ href: dealer.instagram, label: "Instagram", Icon: InstagramIcon })
  if (dealer.tiktok) out.push({ href: dealer.tiktok, label: "TikTok", Icon: TikTokIcon })
  if (dealer.youtube) out.push({ href: dealer.youtube, label: "YouTube", Icon: YoutubeIcon })
  return out
}
