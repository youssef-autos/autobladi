...
/**
 * Uploads a blog image (cover or inline) to Supabase Storage via the
 * service-role client — bypasses storage RLS entirely.
 */
export async function uploadBlogImage(
  ...
  if (file.size > MAX_BYTES) {
    return { ok: false, error: "Taille max 4 MB." }
  }
