...
export default async function ModifierAnnoncePage({
  ...
  let query = supabase
    ...
    .select(
      `id, condition, brand_id, model_id, city_id, secteur_id, year,
       ...
       description, price, contact_phone, contact_whatsapp, video_url,
  ...
  const initialValues: AnnonceFormValues = {
    ...
    mileage: a.mileage,
    fuelType: a.fuel_type ?? "essence",
    transmission: a.transmission ?? "manuelle",
    doors: a.doors ?? 5,
    seats: a.seats ?? 5,
    color: a.color ?? "",
    ...
    firstOwner: a.first_owner ?? false,
    accidentFree: a.accident_free ?? false,
    options,
    title: a.title ?? "",
